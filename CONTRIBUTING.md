# Contributing to AumAI TemplateVerify
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-template-verify/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-template-verify/discussions)
