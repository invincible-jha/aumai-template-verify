# Agent Instructions for TemplateVerify

## Project Context
TemplateVerify is an open source Validate agent project structures against best practices.

## Repository Layout
- `src/aumai_template_verify/` — package source
